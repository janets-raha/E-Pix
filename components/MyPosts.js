...
const MyPosts = () => {
  ...
  const getPosts = () => {
    ...
    myHeaders.append(
      'Authorization',
      'Bearer 9b79d5c13e0b5fcc05d63af002c624456784f4a3'
    );
  ...
  const StarIcon = (props) => <Icon {...props} name="cloud-upload" />;
